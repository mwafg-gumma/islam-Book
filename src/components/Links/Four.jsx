    ...
    return (
        <>
                        ...
                        {recentRemind.map((remind) => (
                            <div key={remind.id} className="mb-6">
                                <div className="flex flex-row items-stretch gap-3 w-full">
                                    {/* one */}
                                    <div className="flex-1 flex flex-col justify-between md:px-3 px-1 py-4 bg-white rounded-md">
                                        <h1 className="py-2 text-amber-500 text-lg md:text-xl font-bold text-right tracking-wide">
                                            {remind.title}
                                        </h1>
                                        <div className="pb-2 flex-1 flex items-center">
                                            <p className="md:text-xl text-lg text-right text-gray-500">
                                                {remind.QuranicVerse}
                                            </p>
                                        </div>
                                        <div className="pt-2 flex flex-row ">
                                            <FaCircleInfo className="text-sky-700 text-2xl mx-2" />
                                            <h3 className="font-bold text-green-700 text-right md:text-xl ">
                                                {remind.Note}
                                            </h3>
                                        </div>
                                    </div>
                                    {/* two */}
                                    <div className="flex items-center justify-center rounded-md bg-teal-400 md:w-[150px] w-[50px] md:h-[130px] h-[70px] m-2">
            ...
            <div className=" mx-4 my-4">
                <p className=" text-gray-500 md:text-2xl text-lg text-right p-5 border border-gray-300 rounded-md">
