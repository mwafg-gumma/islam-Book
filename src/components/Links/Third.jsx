                        ...
                        {recentRemind.map((remind) => (
                            <div key={remind.id} className="mb-6">
                                <div className="flex flex-row items-stretch gap-3 w-full">
                                    {/* one */}
                                    <div className="flex-1 flex flex-col justify-between px-3 py-4 bg-white rounded-md">
                                        ...
                                        <div className="pb-2 flex-1 flex items-center ">
                                            <p className="md:text-xl text-lg text-gray-500 text-right">
                                                {remind.QuranicVerse}
                                            </p>
                                        </div>
                                        <div className="pt-2 flex flex-row justify-center items-center">
                                            <FaCircleInfo className="text-sky-700 text-2xl mx-2" />
                                            <h4 className="font-bold text-green-700 md:text-xl text-right">
                                                {remind.Note}
                                            </h4>
                                        </div>
                                    </div>
                                    {/* two */}
                                    <div className="flex items-center justify-center rounded-md bg-teal-400 md:w-[150px] w-[70px] md:h-[130px] h-[70px] m-2">
